                    ...
                    <form action="{{ route('department.update', $department->id) }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('nome_departamento', $department->nome_departamento) }}"
                        ...
                        <div>
                            ...
                            <textarea name="descricao" 
                                      ...
                                      placeholder="Descreva as responsabilidades e objetivos do departamento...">{{ old('descricao', $department->descricao) }}</textarea>
                            @error('descricao')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
